...
$query = "SELECT * FROM chat WHERE  c_id = $c_id";
...
$result = mysqli_query($conection, "UPDATE chat SET msg='$msg' WHERE c_id=$c_id");
...
<input type="text" name="msg" class="form-input" value="<?php echo $msg; ?>">
</div>
